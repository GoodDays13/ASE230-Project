...
{ ?>
  <div class="container d-flex mt-5">
    ...
    <?php if (isLoggedIn()) { ?>
      ...
      <?php }
    renderThemeToggle();
    if ($pageTitle === 'Public Square') {
      if (has_permission('admin_panel')) { ?>
        <a class="btn btn-outline-primary ms-3 mb-auto" href="admin.php">Admin Panel</a>
      <?php }
    } else { ?>
      <a class="btn btn-outline-primary ms-3 mb-auto" href="index.php">Home</a>
    <?php }
    if (isLoggedIn()) { ?>
      <a class="btn btn-outline-primary ms-3 mb-auto" href="logout.php">Logout</a>
    <?php } else { ?>
      <a class="btn btn-outline-primary ms-3 mb-auto" href="login.php">Login</a>
    <?php } ?>
    </a>
  </div>
<?php
...
{
?>
  <button class="btn btn-secondary ms-auto mb-auto" id="bd-theme" type="button" aria-pressed="false" aria-label="Toggle theme" data-bs-toggle="dropdown" aria-expanded="false">
    <svg class="theme-icon theme-icon-active" width="1em" height="1em">
      <use href="#icon-theme-auto"></use>
    </svg>
  ...
  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="bd-theme">
    <li><button type="button" class="dropdown-item d-flex align-items-center" data-bs-theme-value="light">
        <svg class="theme-icon me-2" width="1em" height="1em">
